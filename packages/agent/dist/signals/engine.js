import { calculateRSI, calculateMACD, calculateEMA, calculateBollingerBands, calculateStochastic, findSupportLevels, findResistanceLevels, calculateADX, } from '@tradeclaw/signals';
 ...
 */
export function computeIndicators(prices, symbol) {
 ...
 */
export function evaluateSignal(indicators) {
    let buyScore = 0;
    let sellScore = 0;
