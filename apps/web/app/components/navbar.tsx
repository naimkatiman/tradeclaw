        ...
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            <select
              ...
              className="hidden sm:block bg-transparent border border-[var(--border)] rounded-full px-2 py-1 text-xs text-[var(--text-secondary)] hover:text-[var(--foreground)] focus:outline-none focus:ring-1 focus:ring-[var(--ring)] cursor-pointer"
            >
            ...
            {!minimal && <a
              ...
              className="hidden sm:flex items-center gap-1.5 rounded-full bg-white/90 px-4 py-1.5 text-xs font-semibold text-black hover:bg-white transition-all duration-300 active:scale-[0.98]"
            >
