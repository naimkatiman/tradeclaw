...
- Minimal navbar variant: logo + wordmark · locale select · UserMenu (sign-in) · GitHub star pill · theme toggle · a single "Open the app →" link (/dashboard). No primary-links row, no More dropdown, no hamburger.
