  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pb-24 md:pb-8">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-10">
        ...
        {/* Disclaimer */}
        <div className="bg-zinc-500/5 border border-zinc-500/20 rounded-xl p-5 space-y-2 text-sm">
          <div className="flex items-center gap-2">
            <AlertTriangle className="w-4 h-4 text-zinc-400" />
            <span className="font-medium text-zinc-300">Important disclaimer</span>
          </div>
