...
const en: TrackRecordTranslations = {
  ...
  surfaces: {
    ...
    researchLabel: 'Research registry',
  },
  periods: { all: 'All' },
  ...
  scope: {
    ...
    broadcastDetail: 'Only observations approved by the live regime, curation, and risk pipeline. Gate decisions are recorded per row since 2026-06-10; earlier rows carry no decision and are excluded from this view.',
    ...
    broadcastCaption: 'Gate-approved view — only observations approved by the live risk pipeline. Decisions are recorded per row since 2026-06-10; older rows are excluded.',
...
const es: TrackRecordTranslations = {
  ...
  surfaces: {
    ...
    researchLabel: 'Registro de investigación',
  },
  ...
  scope: {
    ...
    broadcastDetail: 'Solo observaciones aprobadas por el filtro en vivo de régimen, selección y riesgo. Las decisiones se registran por fila desde 2026-06-10; las filas anteriores se excluyen.',
    ...
    broadcastCaption: 'Vista aprobada por el filtro: solo observaciones aceptadas por el proceso de riesgo. Las decisiones se registran por fila desde 2026-06-10.',
...
const zh: TrackRecordTranslations = {
  ...
  scope: {
    ...
    broadcastDetail: '这里只显示通过实时市场状态、筛选和风险流程的观察记录。自 2026-06-10 起逐行保存门槛决定；更早的记录不包含在此视图中。',
    eligibleCaption: '涵盖所跟踪品种和周期的符合条件信号记录。这不是订阅者的执行记录或投资组合账本。',
    broadcastCaption: '门槛批准视图：仅包含实时风险流程接受的观察记录。决定自 2026-06-10 起逐行保存。',
...
const ms: TrackRecordTranslations = {
  ...
  surfaces: {
    ...
    researchLabel: 'Daftar penyelidikan',
  },
  ...
  scope: {
    ...
    broadcastDetail: 'Hanya pemerhatian yang diluluskan oleh proses rejim, pemilihan dan risiko langsung. Keputusan gerbang direkodkan bagi setiap baris sejak 2026-06-10; baris terdahulu dikecualikan.',
    ...
    broadcastCaption: 'Paparan diluluskan gerbang: hanya pemerhatian yang diterima proses risiko langsung. Keputusan direkodkan sejak 2026-06-10.',
...
const ar: TrackRecordTranslations = {
  ...
  scope: {
    ...
    broadcastDetail: 'يعرض هذا القسم الملاحظات التي وافقت عليها عمليات النظام والانتقاء والمخاطر الحية فقط. تُسجل قرارات البوابة لكل صف منذ 2026-06-10 وتُستبعد الصفوف الأقدم.',
    eligibleCaption: 'تدفق مسجل للإشارات المؤهلة عبر الرموز والأطر الزمنية المتابعة. ليس سجل تنفيذ أو محفظة لمشترك.',
    broadcastCaption: 'عرض موافقة البوابة: الملاحظات التي قبلتها عملية المخاطر الحية فقط. تُسجل القرارات لكل صف منذ 2026-06-10.',
