...
/**
 * Hero — single honest hero.
 *
 * The headline leads with TradeClaw's own finding: after real execution costs,
 * single-asset timing signals have no net edge. The product is the open-source
 * engine + the honest, published track record — NOT a profit promise. The prior
 * 3-variant A/B profit-pitch hero (and its localStorage A/B machinery + the
 * hero signal ticker) was removed 2026-06-28 as off-message; the live feed is
 * now a clearly-labelled transparency exhibit lower on the page. See
 * docs/plans/2026-06-27-reposition-off-raw-pnl.md.
 *
 * (File name kept as ab-hero.tsx to avoid a pure-rename churn; a follow-up may
    ...
    <div className="mb-6 flex justify-center">
      <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-black/35 px-4 py-2.5 shadow-[0_0_40px_rgba(16,185,129,0.08)] backdrop-blur-md">
        ...
        <div className="text-left">
          ...
          <div className="text-xs text-zinc-300">Open-source signal engine · honest track record</div>
        </div>
      </div>
    </div>
  );
    ...
    <section className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden px-4 pt-24 pb-14 text-center sm:px-6 sm:pt-28 sm:pb-16">
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-emerald-500/15 bg-emerald-500/5 px-4 py-1.5 text-xs font-medium uppercase tracking-[0.15em] text-emerald-400">
          ...
          Open source · Honest track record
        </div>

        <h1 className="text-[2.25rem] font-bold leading-[1.05] tracking-[-0.03em] sm:text-6xl lg:text-7xl text-white break-words">
          We tested AI trading signals for two years.
          <br />
          <span className="text-emerald-400" style={{ textShadow: "0 0 40px rgba(52,211,153,0.4)" }}>
            After real costs, they have no edge.
          </span>
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-base text-zinc-400 leading-relaxed sm:text-lg">
          TradeClaw is an open-source signal engine with a public, brutally honest
          track record. Every trade is recorded and re-priced at its real execution
          cost — and the verdict is that single-asset timing doesn&apos;t beat what it
          costs to trade. We published the proof instead of hiding it.
        </p>
        ...
        <p className="mt-3 text-center text-[11px] text-zinc-500">
          The signal engine is free and open source. You can still{' '}
          <Link href="/pricing" className="text-zinc-400 underline hover:text-zinc-200">
            try Pro
          </Link>{' '}
          for instant delivery — but read the track record first.
        </p>
      </div>
    </section>
  );
