...
That same finding, on the live homepage — one dot per OHLCV-resolved sized signal, before and after modeled costs:

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/assets/hero-dark.png" />
  <source media="(prefers-color-scheme: light)" srcset="docs/assets/hero-light.png" />
  <img src="docs/assets/hero-dark.png" alt="tradeclaw.win homepage showing the cost-aware signal field after modeled costs, with most resolved trades below zero" width="100%" />
</picture>
