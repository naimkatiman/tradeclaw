    ...
    <svg viewBox="0 0 120 120" fill="none" role="img" aria-label="TradeClaw" className={className}>
      <defs>
        <linearGradient id={gradId} x1="34" y1="28" x2="89" y2="90" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#b9f7ff" />
          <stop offset="48%" stopColor="#15d8f4" />
        ...
        <radialGradient id={glowId} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60 55) rotate(90) scale(38)">
          <stop offset="0%" stopColor="#15d8f4" stopOpacity="0.32" />
          <stop offset="100%" stopColor="#15d8f4" stopOpacity="0" />
        </radialGradient>
      </defs>
      <rect x="6" y="6" width="108" height="108" rx="28" fill="#05070a" />
      <rect x="6" y="6" width="108" height="108" rx="28" stroke="#12343c" strokeWidth="1.5" />
      ...
      <path d="M31 87L46 75L59 79L75 62L89 67" stroke="#9ceffc" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="89" cy="67" r="4.5" fill="#d9fbff" />
    </svg>
  );
}
...
export const TRADECLAW_LOGO_SVG = (size = 28, id = "tc-html") => `<svg viewBox="0 0 120 120" fill="none" width="${size}" height="${size}" role="img" aria-label="TradeClaw">
  <defs>
    <linearGradient id="${id}-claw" x1="34" y1="28" x2="89" y2="90" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="48%" stop-color="#15d8f4"/>
    ...
    <radialGradient id="${id}-glow" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60 55) rotate(90) scale(38)">
      <stop offset="0%" stop-color="#15d8f4" stop-opacity="0.32"/>
      <stop offset="100%" stop-color="#15d8f4" stop-opacity="0"/>
    </radialGradient>
  </defs>
  <rect x="6" y="6" width="108" height="108" rx="28" fill="#05070a"/>
  <rect x="6" y="6" width="108" height="108" rx="28" stroke="#12343c" stroke-width="1.5"/>
  ...
  <path d="M31 87L46 75L59 79L75 62L89 67" stroke="#9ceffc" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/>
  <circle cx="89" cy="67" r="4.5" fill="#d9fbff"/>
</svg>`;
