...
const PROFILES: Record<ProfileKey, Profile> = {
  scalper: {
    ...
    color: 'text-zinc-400',
    description:
      'You prefer short observation windows and frequent chart review. Treat this result as a UI profile only, not a recommendation or evidence of expected profit.',
