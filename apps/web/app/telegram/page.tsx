      ...
      <div className="max-w-4xl mx-auto px-6 py-8 pb-40 md:pb-20 space-y-6">
        ...
        <Card>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="font-medium">Public Signal Channel</h2>
          </div>
          <p className="text-sm text-zinc-500 mb-4">
            Every signal is broadcast to the free public Telegram channel — no account, no
            subscription, no delay. Everything on tradeclaw.win is free.
          </p>
          ...
          <div className="rounded-lg border border-emerald-500/10 bg-emerald-500/[0.03] p-4">
            ...
            <p className="mt-2 text-xs text-zinc-500">
              Opens Telegram directly. Entry, SL, and the full TP ladder on every broadcast.
            </p>
          </div>
        </Card>
