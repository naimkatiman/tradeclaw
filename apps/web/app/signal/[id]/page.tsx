 ...
 * live engine writes (see signal-generator.ts).
 */
...
export default async function SignalPage(
  ...
  // Live TA is best-effort: feeds the indicator card and the chart markers.
  // If a record exists, the page still renders without it.
  ...
  const signal: TradingSignal = record
  ...
  return (
    <div className="min-h-[100dvh] bg-[#050505] text-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        {/* Price Chart with entry, SL, and TP lines */}
        <SignalChartSection
          entry={signal.entry}
