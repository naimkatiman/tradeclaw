...
- `df8adeb4` (#136) charges real per-row execution cost (`cost_estimate_pct`, migration 051) on the public equity curve — the flat 0.02% charge was ~22.3x understated per the commit's own measurement.
