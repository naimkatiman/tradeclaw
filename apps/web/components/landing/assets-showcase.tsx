...
const COLOR_MAP: Record<string, { badge: string; text: string; dot: string }> =
  {
    emerald: {
      badge:
<<<<<<< HEAD
        "border-emerald-500/20 bg-emerald-500/6 text-emerald-300 hover:border-emerald-500/40",
...
>>>>>>> origin/main
    ...
    sky: {
      badge:
<<<<<<< HEAD
        "border-sky-500/20 bg-sky-500/6 text-sky-300 hover:border-sky-500/40",
      text: "text-sky-400",
=======
...
>>>>>>> origin/main
    ...
    amber: {
      badge:
<<<<<<< HEAD
        "border-amber-500/20 bg-amber-500/6 text-amber-300 hover:border-amber-500/40",
      text: "text-amber-400",
=======
