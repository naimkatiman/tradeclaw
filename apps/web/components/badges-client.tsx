...
function BadgeCard({
  ...
  const rstSnippet = `.. image:: ${badgeUrl}\n   :target: ${linkUrl}\n   :alt: ${name} Signal`;
  const asciidocSnippet = `image:${badgeUrl}["${name} Signal", link="${linkUrl}"]`;
  ...
  return (
    <div className="border border-white/10 rounded-xl p-4 space-y-4 bg-white/[0.02] hover:bg-white/[0.04] transition-colors">
      ...
      <div className="space-y-3">
        ...
        <CodeBlock label="reStructuredText" code={rstSnippet} />
        <CodeBlock label="AsciiDoc" code={asciidocSnippet} />
      </div>
    </div>
  );
}
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-[var(--text-secondary)] max-w-xl mx-auto text-sm leading-relaxed">
            ...
            Drop them into any GitHub README, docs, or website. No API key required.
          </p>
        ...
        <div className="space-y-4 p-6 rounded-xl border border-white/10 bg-white/[0.02]">
          ...
          <p className="text-sm text-[var(--text-secondary)]">
            Add BTC, ETH and Gold badges to your README in one line:
          </p>
          <CodeBlock
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 text-sm text-[var(--text-secondary)]">
            <div className="space-y-1">
        ...
        <p className="text-center text-xs text-[var(--text-secondary)]">
          ...
          <a href="/docs/api" className="text-emerald-400 hover:text-emerald-300 transition-colors">
            Full API docs →
          </a>
        </p>
      </div>
